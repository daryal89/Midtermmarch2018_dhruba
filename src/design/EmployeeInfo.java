...
public class EmployeeInfo extends AbstractEmployee {
   ...
   // private double salary;
    ...
    public void describeCompany() {
        companyName = "AddNTech";
        System.out.println(companyName + " is founded by " + founderName + " in 2009 and is located at  " + address + ".");
    }
    ...
    public void benefitLayout() {
        System.out.println("Employees have yearly two weeks paid vacation.");
